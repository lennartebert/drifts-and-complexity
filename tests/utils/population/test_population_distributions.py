...
class TestPopulationDistributions:
    ...
    def test_creation_basic(self):
        ...
        dists = PopulationDistributions(
            activities=activities, dfg_edges=dfg_edges, trace_variants=trace_variants
        )
    ...
    def test_equality_comparison(self):
        ...
        dists1 = PopulationDistributions(
            activities=activities1, dfg_edges=dfg_edges1, trace_variants=trace_variants1
        )
        ...
        dists2 = PopulationDistributions(
            activities=activities2, dfg_edges=dfg_edges2, trace_variants=trace_variants2
        )
    ...
    def test_empty_distributions(self):
        ...
        empty_dist = PopulationDistribution(
            observed_labels=[], observed_probs=[], unseen_count=0, p0=0.0, n_samples=0
        )

        dists = PopulationDistributions(
            activities=empty_dist, dfg_edges=empty_dist, trace_variants=empty_dist
        )
