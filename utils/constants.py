...
METRIC_NAMES_TO_LATEX_MAP = {
    ...
    "Number of Distinct Activities": "|Act.|",
    "Number of Traces": "\\#Traces",
    "Number of Distinct Traces": "|Traces|",
    "Number of Distinct Directly-Follows Relations": "|DFR|",
    "Min. Trace Length": "Min. TL",
    "Avg. Trace Length": "Avg. TL",
    "Max. Trace Length": "Max. TL",
    "Percentage of Distinct Traces": "\\%|Traces|",
    "Average Distinct Activities per Trace": "Avg. |Act.|/Trace",
    "Structure": "Structure",
    "Estimated Number of Acyclic Paths": "Est. |AP|",
    "Number of Ties in Paths to Goal": "\\#TPG",
