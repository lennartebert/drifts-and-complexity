...
METRIC_DIMENSION_MAP = {
    "Number of Events": "Length", # Used to be length
    "Number of Traces": "Length", # Used to be length
...
METRIC_NAMES_TO_LATEX_MAP = {
    "Number of Events": "$\\#\\text{Events}$",
    "Number of Distinct Activities": "$|\\text{Act.}|$",
    "Number of Traces": "$\\#\\text{Traces}$",
    "Number of Distinct Traces": "$|\\text{Traces}|$",
    "Number of Distinct Directly-Follows Relations": "$|\\text{DFR}|$",
    "Min. Trace Length": "$\\text{Min. TL}$",
    "Avg. Trace Length": "$\\text{Avg. TL}$",
    "Max. Trace Length": "$\\text{Max. TL}$",
    "Percentage of Distinct Traces": "$\\%|\\text{Traces}|$",
    "Average Distinct Activities per Trace": "$\\text{Avg.\\ } | \\text{Act.}| /\\text{Trace}$",
    "Structure": "$\\text{Structure}$",
    "Estimated Number of Acyclic Paths": "$\\text{Est.\\ } |\\text{AP}|$",
    "Number of Ties in Paths to Goal": "$\\#\\text{TPG}$",
    "Lempel-Ziv Complexity": "$\\text{LZ}$",
    "Average Affinity": "Avg.\\ Affinity",
    "Deviation from Random": "Dev.\\ from Rand.",
    "Average Edit Distance": "Avg.\\ Edit Dist.",
    "Sequence Entropy": "Seq.\\ Entropy",
    "Normalized Sequence Entropy": "Norm.\\ Seq.\\ Entropy",
    "Variant Entropy": "Var.\\ Entropy",
    "Normalized Variant Entropy": "Norm.\\ Var.\\ Entropy",
}
