"""Structure metric implementation."""
...
class Structure(TraceMetric):
    """Structure measure based on Günther 2009.
    ...
    def compute(self, traces: List[Trace], measures: MeasureStore) -> None:
        ...
        value = (
            1
            - number_of_activity_transitions.value
            / number_of_distinct_activities.value**2
        )
        ...
        measures.set(
            ...
            hidden=False,
            meta={
                "definition": "1 - distinct DF / (distinct activities)**2",
                "basis": "derived",
            },
        )
