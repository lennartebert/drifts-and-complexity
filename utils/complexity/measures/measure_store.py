...
class MeasureStore:
    ...
    def __init__(
        self, initial: Optional[Union["MeasureStore", Dict[str, Measure]]] = None
    ):
    ...
    def set(
        ...
        *,
        ...
        self._measures[name] = Measure(
            name=name, value=float(value), hidden=hidden, meta=meta or {}
        )
    ...
    def get_value(
        self, name: str, get_normalized_if_available: bool = False
    ) -> Optional[float]:
    ...
    def to_visible_dict(
        self, get_normalized_if_available: bool = False
    ) -> Dict[str, float]:
